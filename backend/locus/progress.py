...
def continuation_state(detail):
    ...
    can_review = queue["review"] or queue["analyze"] or detail["conclusion"]["pending_cards"]
    ...
    return {"blocked_by": blocked, "exhausted": exhausted, "pending_steps": sum(queue.values())}
